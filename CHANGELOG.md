...
- refactor CreateSpecForm to use a single description textarea and add image attachment functionality
- add unit tests for KnownAgentDetector, KnownAgentPreferencesService, and HookViewProvider
- Enhance MCP Tools Selector and Trigger Action Selector with ACP Agent support
- updated documentation to the last version generated by GatomIA
- add integration tests for tree-view activation pattern and unit tests for SpecExplorerProvider

### Fixed

- update performance test threshold and refine regex for replace warning message

### Changed

- chore: update devDependencies and refactor tests for vitest 4.x compatibility

### Release Info

- **Source Branch**: `013-create-spec-ui-redesign`
- **Release Type**: patch
