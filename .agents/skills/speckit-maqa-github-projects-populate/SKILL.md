...
description: Populate GitHub Project from specs/*/tasks.md. Creates one draft issue
  per feature with a markdown task list. Skips features already in the project. Safe
  to re-run.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: maqa-github-projects:commands/speckit.maqa-github-projects.populate.md
---
